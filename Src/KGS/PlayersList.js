...
var g_oKGSRoomsList = {
	...
	SortType : -EKGSRoomsListRecord.Category,
	...
	SortFunction : function(oRecord1, oRecord2)
	{
		...
		//
		// var SortType = g_oPlayersList.SortType;
		// if (g_oKGSRoomsList.Name === SortType)
		// {
		// 	if (oRecord1.m_sName < oRecord2.m_sName)
		// 		return -1;
		// 	else if (oRecord1.m_sName > oRecord2.m_sName)
		// 		return 1;
		// }
		// else if (-g_oKGSRoomsList.Name === SortType)
		// {
		// 	if (oRecord1.m_sName < oRecord2.m_sName)
		// 		return 1;
		// 	else if (oRecord1.m_sName > oRecord2.m_sName)
		// 		return -1;
		// }
		// else if (g_oKGSRoomsList.Rank === SortType)
		// {
		// 	if (oRecord1.m_nRank < oRecord2.m_nRank)
		// 		return -1;
		// 	else if (oRecord1.m_nRank > oRecord2.m_nRank)
	...
	Handle_DoubleClick : function(Record)
	{
		if (oClient)
		{
			oClient.EnterChatRoom(Record.m_nRoomId);
		}
	}
};
...
CKGSRoomListRecord.prototype.Draw = function(oContext, dX, dY, eType)
{
    ...
    switch(eType)
    {
		case EKGSRoomsListRecord.RoomId   : sString += "" + this.m_nRoomId; break;
